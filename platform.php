...
$platform = isset($_GET['gamePlatform']) ? $_GET['gamePlatform'] : '';
$platform = mysqli_real_escape_string($db, $platform);

$sql = "SELECT * FROM games WHERE gamePlatform='$platform'";
    ...
    <body>
        ...
        <section class="container mt-5">
            <div class="card-container">
                <h2 class="section-header"><?php echo htmlspecialchars($platform); ?> Oyunları</h2>
                <hr><br><br>
                <div class="row">
                    <?php
                    if (mysqli_num_rows($cevap) > 0) {
                        ...
                        echo "<p>No games found in this category.</p>";
                    }
                    ?>
                </div>
            </div>
