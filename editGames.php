...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    // UPDATE sorgusu ile sadece değiştirilen verileri güncelle
    $updateQuery = "UPDATE `games` SET ";
    $updateQuery .= "`gameCategory` = '".$gameCategory."', ";
    $updateQuery .= "`gameInfo` = '".$gameInfo."', ";
    $updateQuery .= "`gameImage1` = '".$targetFile1."', ";
    $updateQuery .= "`gameImage2` = '".$targetFile2."', ";
    $updateQuery .= "`gameDownloadLink` = '".$downloadLink."', ";
    $updateQuery .= "`gameGithubLink` = '".$githubLink."', ";
    $updateQuery .= "`gameIcon` = '".$targetFile3."', ";
    $updateQuery .= "`gamePlatform` = '".$gamePlatform."' ";
    $updateQuery .= "WHERE `gameName` = '".$gameName."' AND `gameCreator` = '".$userName."'";

    // Veritabanı güncelleme sorgusunu çalıştır
    $rt = mysqli_query($db, $updateQuery);
...
<head>
    ...
    <title>Edit Game - GameNest</title>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <select class="form-control" id="gameName" name="gameName" required>
                        ...
                        <?php
                        // Kullanıcının sahip olduğu tüm oyunları veritabanından al
                        $userName = $_SESSION['username'];
                        $result = mysqli_query($db, "SELECT gameName FROM games WHERE gameCreator = '$userName'");
                        // Her bir oyun için bir seçenek oluştur
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="gameCategory" name="gameCategory" require>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="gamePlatform" name="gamePlatform" require>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="gameInfo" rows="3" name="gameInfo" placeholder="Introduce your game" require></textarea>
                    </div>
                    <div class="form-group">
                        <label for="gameIcon">Game Icon</label>
                        <input type="file" class="form-control-file" id="gameIcon" name="gameIcon" require>
                    </div>
                    <div class="form-group">
                        <label for="gameImage1">Game Image 1</label>
                        <input type="file" class="form-control-file" id="gameImage1" name="gameImage1" require>
                    </div>
                    <div class="form-group">
                        <label for="gameImage2">Game Image 2</label>
                        <input type="file" class="form-control-file" id="gameImage2" name="gameImage2" require>
                    </div>
                    <div class="form-group">
                        <label for="downloadLink">Download link</label>
                        <input type="url" class="form-control" id="downloadLink" name="downloadLink" placeholder="Enter your game Drive link" require>
                    </div>
                    <div class="form-group">
                        <label for="githubLink">GitHub</label>
                        <input type="url" class="form-control" id="githubLink" name="githubLink" placeholder="Enter your GitHub game link" require>
                    </div>
                    <br><br>
